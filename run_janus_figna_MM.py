...
class Bagel_sim():
    ...
    def read_from_json(self, cfg_path=None):
        if cfg_path is None:
            ...
            cfg_path = os.path.join(base, "topologies", "janus", "config_figna_janus_MM.json")
    ...
    def run_gen_image(self):
       ...
       # 三个不同KV配置的图像生成
        ...
        for config_name, kv_len in kv_configs:
            ...
            input_cycles = self.run_sim_once_comp(kv_length=kv_len, is_gen_text=False, part='qkv', config=self.config_int4)
