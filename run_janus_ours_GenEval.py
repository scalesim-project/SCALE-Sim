...
class Bagel_sim():
    ...
    def read_from_json(self, cfg_path=None):
        if cfg_path is None:
            ...
            cfg_path = os.path.join(base, "topologies", "janus", "config_ours_janus_GenEval.json")
    ...
    def run_gen_image(self):
        ...
        kv_without_text = max(int((self.kv_cache_without_text + self.gen_image_step) * self.sparsity_cross_attn) + kv_low_prec_self_attn, kv_high_prec_attn)
