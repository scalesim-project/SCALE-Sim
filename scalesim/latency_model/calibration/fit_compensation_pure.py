...
pure per-op models (op_calibration.py collect -> train -> model/<gen>).
...
Usage:
  ...
  # -> prints a1, C0; paste into COMPENSATION_BY_GEN["TPUv6e"] in latency_model/compensation.py
"""
import argparse, csv, glob, os, subprocess, sys
import numpy as np

HERE = os.path.dirname(os.path.abspath(__file__))
ROOT = os.path.abspath(os.path.join(HERE, "..", "..", ".."))  # calibration->latency_model->scalesim->repo
