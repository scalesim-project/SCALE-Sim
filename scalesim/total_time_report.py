...
COMPENSATION_BY_GEN = {
    ...
    # fit_compensation_v6e.py). a1=0.0295 (~97% of non-compute fused away, matching
    # v4's 0.028); C_forward=491us per-forward overhead. In-sample 7.2% MAPE,
    # leave-one-model-out 13.8%. Same qwen/seq128 weak spot as v4. Uses the v6e
    # GEMM term (TPUV6E_REGION_TABLE) + v6e batch reduction so Sum(GEMM) < truth.
