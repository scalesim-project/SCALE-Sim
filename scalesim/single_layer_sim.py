...
class single_layer_sim:
    ...
    def __init__(self):
        ...
        # PE action counts (for Accelergy energy estimation)
    ...
    def run(self):
        ...
        # 1.5 Get PE action counts for Accelergy energy estimation
    ...
    # Run the Accelergy energy model to generate REPEAT_CYCLE.csv
